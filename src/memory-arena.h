...
// allocates nbytes aligned to the default alignment. Returns NULL on out-of-memory 
...
/* restore arena to previous checkpoint, freeing everything allocated since. Must be called with
checkpoint from same arena */
